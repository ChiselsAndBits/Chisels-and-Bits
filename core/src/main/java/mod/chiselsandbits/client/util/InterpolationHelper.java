 ...
 * @author Covers1624 -> Permission granted for reuse
 */
public class InterpolationHelper {
    ...
    public InterpolationHelper(float dx0, float dy0, float dx1, float dy1, float dx2, float dy2, float dx3, float dy3) {
        reset(dx0, dy0, dx1, dy1, dx2, dy2, dx3, dy3);
        setup();
    }
    ...
    /**
     * Resets the interpolation helper with the given quad. Does not care what order the vertices are in.
     */
     ...
     *
     * @param x X interpolation location.
     * @param y Y interpolation location.
     */
